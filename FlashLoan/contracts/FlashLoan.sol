...
contract FlashLoan {
    ...
    address private constant USDC = 0x155ff1A85F440EE0A382eA949f24CE4E0b751c65;
    address private constant LINK = 0x1B8568FbB47708E9E9D31Ff303254f748805bF21;
    ...
    function placeTrade(
        ...
        uint256[] memory amountRequired1 = IUniswapV2Router01(router)
            .getAmountsOut(_amountIn, path);
        console.log("amountRequired1>>", amountRequired1[0]);
        console.log("amountRequired2>>", amountRequired1[1]);
    ...
    function uniswapV2Call(
        ...
        console.log("Address Bal>>", myAddress.balance);
        ...
        console.log("fee:", fee);
        console.log("Profit:", trade2Coin, "myaddress:", myAddress);
